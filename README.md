...
Настроены линтеры
Настроен роутинг
Сделана базовая интеграция c api: 
...
получение и отправка сообщений в реальном времени через Websockets.
Написаны тесты на Block, Router, HTTP - модуль и WebSocket - модуль
Настроен husky - precommit
